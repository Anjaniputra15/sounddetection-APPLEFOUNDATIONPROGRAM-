//
//  SystemClassificationDealing.swift
//  SystemClassificationDealing
//
...
struct SystemClassificationDealing {

      func startClassification () {
         var monitoredSounds = Set<SoundIdentifier>()
         let classificationSubject = PassthroughSubject<SNClassificationResult, Error>()
        monitoredSounds.insert(SoundIdentifier(labelName:   "bird_vocalization" , displayName:  "Bird Vocalization"    ))
